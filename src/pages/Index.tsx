        ...
        <div className="space-y-6">
          <div className="px-4 flex items-start">
            ...
            <div>
              ...
              <div className="text-gray-700 dark:text-gray-300">+254 790 298 003</div>
            </div>
          </div>
          <div className="px-4 flex items-start">
          ...
          <div className="px-4 flex items-start">
            ...
            <div>
              <div className="font-semibold text-neutral-800 dark:text-white">Nairobi – Head Office</div>
              <div className="text-gray-700 dark:text-gray-300">Nairobi</div>
            </div>
          </div>
          <div className="px-4 flex items-start">
            <MapPin className="h-6 w-6 text-red-500 mr-4 mt-1" />
