    ...
    <div className="bg-white">
      ...
      <section className="py-16 px-4 max-w-5xl mx-auto text-gray-800">
        ...
        <p className="text-lg leading-8 mb-6">
          At <strong>Jolu Group Security</strong>, our expertly trained K9 units add a
          heightened layer of protection for a variety of security operations. From
          narcotics and explosives detection to perimeter patrols and crowd control, our
          dogs are reliable, fast-acting, and professionally handled.
        </p>
        <p className="text-lg leading-8 mb-6">
          These highly skilled canine teams operate under strict protocols, ensuring
          effective threat detection while upholding safety and professionalism. Whether
          it's a high-profile event, facility patrol, or rapid response need, our K9s
          stand ready.
        </p>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow hover:shadow-md transition">
              ...
              <p>
                Our dogs are trained to detect contraband, weapons, and explosives with
                remarkable precision and calmness.
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow hover:shadow-md transition">
              <h4 className="font-bold text-lg text-red-700 mb-2">Rapid Response</h4>
              <p>
                K9 units can immediately respond to high-alert scenarios, offering a mobile
            ...
            <div className="bg-white p-6 rounded-lg shadow hover:shadow-md transition">
              ...
              <p>
                Each dog is paired with a certified handler who ensures control, safety,
                and mission-ready performance at all times.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-red-700 text-white text-center">
        ...
        <p className="text-lg mb-8">
          Contact us for specialized K9 deployment tailored to your unique security needs.
        </p>
        <Link to="/quote">
